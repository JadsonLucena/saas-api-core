...
CREATE TYPE ecommerce."document_type" AS ENUM (
  'TAX_ID',
  'LEI',
  'PASSPORT'
);
...
CREATE TYPE ecommerce."country" AS ENUM ( -- ISO-3166-1 alpha-2
  'AF',
  'AX',
  'AL',
  'DZ',
...
CREATE TYPE ecommerce."subscription_event_type" AS ENUM (
  'RENEW_DISABLED',
  'RENEW_ENABLED',
  'PAUSED',
  'RESUMED',
...
CREATE TYPE ecommerce."ledger_type" AS ENUM (
  'CREDIT',
  'DEBIT',
  'REFUND'
);

CREATE TYPE ecommerce."ledger_referrer" AS ENUM (
  'ADJUSTMENT',
  'CONSUMPTION',
  'GIFT_CARD',
  'OTHER',
...
-- Compliance with prior consent for sending marketing and promotional communications
CREATE TABLE IAM."user_consent_event" (
  "id" uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  "user_id" uuid NOT NULL,
  "channel" IAM."consent_channel" NOT NULL,
  "is_accepted" boolean NOT NULL, -- opt-in, opt-out
  "created_at" timestamptz NOT NULL DEFAULT now(),
...
CREATE TABLE IAM."api_token" (
  ...
  "role_id" int NOT NULL,
  "starts_in" timestamptz NOT NULL,
  "expires_in" timestamptz NOT NULL,
  "created_at" timestamptz NOT NULL DEFAULT now(),
  "disabled_at" timestamptz,
...
CREATE TABLE IAM."oauth" (
  ...
  "terms_of_service_id" INT NOT NULL,
  ...
  FOREIGN KEY ("member_id") REFERENCES IAM."member" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY ("role_id") REFERENCES IAM."role" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
  FOREIGN KEY ("privacy_policy_id") REFERENCES IAM."privacy_policy" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
  FOREIGN KEY ("terms_of_service_id") REFERENCES IAM."terms_of_service" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE IAM."privacy_policy" (
  "id" INT PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE IAM."terms_of_service" (
  "id" INT PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
  "hash" VARCHAR(255) NOT NULL,
  "link" varchar(255) NOT NULL,
  "created_at" timestamptz NOT NULL DEFAULT now(),
...
CREATE TABLE IAM."privacy_policy_acceptance_event" (
  "id" uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  "user_id" UUID NOT NULL,
  "privacy_policy_id" int NOT NULL,
  "ip_address" INET,
...
CREATE TABLE IAM."terms_of_service_acceptance_event" (
  "id" uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  "user_id" UUID NOT NULL,
  "terms_of_service_id" int NOT NULL,
  "ip_address" INET,
  ...
  UNIQUE ("user_id", "terms_of_service_id"),
...
CREATE TABLE ecommerce."address" (
  "id" INT PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
  "country" ecommerce."country" NOT NULL,
  ...
  UNIQUE ("country", "postal_code", "street"),
...
CREATE TABLE ecommerce."discount" (
  ...
  "starts_in" timestamptz NOT NULL DEFAULT now(),
...
CREATE TABLE ecommerce."subscription_event" (
  "id" uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  "subscription_id" uuid NOT NULL,
  "type" ecommerce.subscription_event_type NOT NULL,
  "data" jsonb NOT NULL,
  "note" text,
  "created_at" timestamptz NOT NULL DEFAULT now(),
...
CREATE TABLE ecommerce."payment_gateway_webhook_event" (
  "id" INT PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
  "payment_id" uuid NOT NULL,
  "status" ecommerce.payment_gateway_webhook_event_status NOT NULL,
...
CREATE TABLE ecommerce."ledger" (
  ...
  "type" ecommerce.ledger_type NOT NULL,
  "referrer" ecommerce.ledger_referrer NOT NULL,
  "data" jsonb NOT NULL,
  "note" text,
  "created_at" timestamptz NOT NULL DEFAULT now(),
  ...
  FOREIGN KEY ("account_id") REFERENCES IAM."account" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);

CREATE TABLE ecommerce."privacy_policy" (
  "id" INT PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
  "hash" VARCHAR(255) NOT NULL,
  "link" varchar(255) NOT NULL,
  "created_at" timestamptz NOT NULL DEFAULT now(),
...
CREATE TABLE ecommerce."terms_of_service" (
  "id" INT PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
  "hash" VARCHAR(255) NOT NULL,
  "link" varchar(255) NOT NULL,
  "created_at" timestamptz NOT NULL DEFAULT now(),
...
CREATE TABLE ecommerce."privacy_policy_acceptance_event" (
  "id" uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  "user_id" UUID NOT NULL,
  "privacy_policy_id" int NOT NULL,
  "ip_address" INET,
  ...
  FOREIGN KEY ("user_id") REFERENCES IAM."user" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY ("privacy_policy_id") REFERENCES ecommerce."privacy_policy" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);

CREATE TABLE ecommerce."terms_of_service_acceptance_event" (
  "id" uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  "user_id" UUID NOT NULL,
  "terms_of_service_id" int NOT NULL,
  "ip_address" INET,
  ...
  FOREIGN KEY ("user_id") REFERENCES IAM."user" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY ("terms_of_service_id") REFERENCES ecommerce."terms_of_service" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
